...
train_dataset_path  =  'data/all/alltrain_data.npy'
train_labels_path = 'data/all/alltrain_label.npy'



val_dataset_path = 'data/val/sval_data.npy'
val_labels_path = 'data/val/sval_label.npy'
# val_dataset_path = 'data/all/alltrain_data.npy'
# val_labels_path = 'data/all/alltrain_label.npy'
...
torch.save(models[model_name]['model'].state_dict(),'all_model.pth')